 ...
 * between linkrightd, and linkright-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("linkright-shutoff");
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-maxtimeadjustment", strprintf(_("Maximum allowed median peer time offset adjustment. Local perspective of time may be influenced by peers forward or backward by this amount. (default: %u seconds)"), DEFAULT_MAX_TIME_ADJULRENT));
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/linkright/linkright>";
    const std::string URL_WEBSITE = "<https://linkright.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("linkright-loadblk");
...
/** Sanity checks
 *  Ensure that LinkRight is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single LinkRight process is using the data directory.
