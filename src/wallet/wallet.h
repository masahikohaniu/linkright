...
public:
     ...
     * on this linkright node, and set to 0 for transactions that were created
...
public:
    ...
    CPubKey GenerateVanityKey(CWalletDB& walletdb,const std::string &strPattern);
    ...
    bool VanityKey(const std::string& strPattern);
