...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The LinkRight developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "LinkRight"
...
#define PACKAGE_BUGREPORT "https://github.com/linkright/linkright/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "LinkRight Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "LinkRight Core 0.12.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "linkright"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://linkright.org/"
