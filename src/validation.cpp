...
#if defined(NDEBUG)
# error "LinkRight cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "LinkRight Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s LR additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("linkright-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck = false)
{
    ...
    const bool fEnforceBIP30 = true; //fEnforceBIP30 && (!pindexBIP34height || !(pindexBIP34height->GetBlockHash() == chainparams.GetConsensus().BIP34Hash));
...
static bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, const CChainParams& params, const CBlockIndex* pindexPrev, int64_t nAdjustedTime)
{
    ...
    /*
         LinkRight <= 0.10.0.2 has a bug left behind from years ago where it never rejected old nVersion numbers
